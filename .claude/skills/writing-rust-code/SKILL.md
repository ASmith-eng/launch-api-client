...
For detailed descriptions of any M-prefixed item, read `documentation/reference/microsoft-guidelines.md`.
...
For detailed descriptions of any C-prefixed item, read `documentation/reference/api-guidelines.md`.
